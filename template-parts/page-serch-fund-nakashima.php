<div class="page-wrapper">
  <section class="section">
    ...
    <h2 class="searchfund-main-title">
      <p class="pc_only">中島光夫が考える日本発サーチファンド型M&Aとは？</p>
      <p class="sp_only">中島光夫が考える、<br/>日本発サーチファンド型M&A</p>
      <p class="searchfund-main-subtitle">大廃業時代の中小企業を次世代へとつなぐ決意</p>
    </h2>
    <?php
